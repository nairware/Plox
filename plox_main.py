...
hand_list = [hand] * number_of_players
hand_list[0] = [deck[51], deck[39], deck[38], deck[26]] #AsAhTcJd
hand_list[1] = [deck[25], deck[13], deck[12], deck[0]]  #AcAd9d6d
del deck[51]; del deck[39]; del deck[38]; del deck[26]  #card removal
del deck[25]; del deck[13]; del deck[12]; del deck[0]  #card removal
